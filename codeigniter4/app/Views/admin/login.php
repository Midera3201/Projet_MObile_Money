...
<body>
    <div class="login-card p-5">
        <div class="text-center mb-4">
            ...
            <div class="login-sub mt-1">Administration</div>
        </div>
        ...
        <form method="post" action="/admin/login">
            <div class="mb-3">
                <label class="form-label" style="font-size:13px;font-weight:500;">Utilisateur</label>
                <input type="text" class="form-control" name="username" placeholder="Nom d'utilisateur" required>
            </div>
            <div class="mb-4">
                <label class="form-label" style="font-size:13px;font-weight:500;">Mot de passe</label>
