...
<div class="card">
    <div class="card-header bg-white"><h5 class="mb-0">Liste des types</h5></div>
    <div class="card-body">
        <table class="table table-bordered mb-0">
            <thead class="table-light"><tr><th>ID</th><th>Nom</th><th>Description</th><th>Actif</th><th>Actions</th></tr></thead>
            <tbody>
